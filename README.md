...
- Basic Auth защита — пароль хранится на сервере, не в HTML
...
4. Запрашивает домен и получает TLS-сертификат автоматически
5. Клонирует репозиторий personal_mtproxy
6. Применяет патчи (расширенный API, Basic Auth, страница-заглушка, метрики)
...
- Активные соединения и статистику подключений
